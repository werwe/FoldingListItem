...
public class BaseFoldingLayout extends ViewGroup {
    ...
    public void fold ()
    {
        float foldFactor = getFoldFactor();
        ObjectAnimator animator = ObjectAnimator.ofFloat(this, "foldFactor", foldFactor, 1);
        animator.setDuration(mAnimationDuration);
        animator.setInterpolator(new AccelerateInterpolator());
        animator.addListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(Animator animation) {
                Log.d("FoldingLayout", "fold end");
            }
        });
        animator.start();
    }
    ...
    {
        float foldFactor = getFoldFactor();
        ObjectAnimator animator = ObjectAnimator.ofFloat(this, "foldFactor", foldFactor, 0);
        animator.setDuration(mAnimationDuration);
        animator.setInterpolator(new AccelerateInterpolator());
